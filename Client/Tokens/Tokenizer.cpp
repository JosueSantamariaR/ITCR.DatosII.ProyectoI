...
/**
 * @brief Metodo que se encarga de obtener los tokens por medio del analisis del archivo.
 * @param string
 * @authors Akion&Josue
 */
...
/**
 * @brief Metodo que se encarga de establecer el ultimo token.
 * @param Token
 * @param vector<Token>
 * @authors Akion&Josue
 */
...
/**
 * @brief Metodo que se encarga de imprimir los tokens y sus valores.
 * @authors Akion&Josue
 */
