...
QT_MOC_LITERAL(1, 14, 12), // "jsonReceived"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "jsonDoc"
QT_MOC_LITERAL(4, 36, 22), // "disconnectedFromClient"
QT_MOC_LITERAL(5, 59, 5), // "error"
QT_MOC_LITERAL(6, 65, 10), // "logMessage"
QT_MOC_LITERAL(7, 76, 3), // "msg"
QT_MOC_LITERAL(8, 80, 20), // "disconnectFromClient"
QT_MOC_LITERAL(9, 101, 11) // "receiveJson"

    },
    "serverConnect\0jsonReceived\0\0jsonDoc\0"
...
void serverConnect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (serverConnect::*)(const QJsonObject & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serverConnect::jsonReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serverConnect::disconnectedFromClient)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (serverConnect::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serverConnect::error)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (serverConnect::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serverConnect::logMessage)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject serverConnect::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_serverConnect.data,
    qt_meta_data_serverConnect,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void serverConnect::jsonReceived(const QJsonObject & _t1)
{
...
// SIGNAL 1
void serverConnect::disconnectedFromClient()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void serverConnect::error()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void serverConnect::logMessage(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
